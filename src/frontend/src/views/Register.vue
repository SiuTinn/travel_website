            ...
            <div class="card bg-secondary shadow border-0">
                ...
                <div class="card-body px-lg-5 py-lg-5">
                    ...
                    <form role="form">
                        <div class='row'>
                            <div class='col-lg-6'>
                                <base-input @focus="login_error.visible=false"
                            ...
                            <div class='row'>
                                <div class="col-lg-6">
                                    <base-button @click="model.gender='男'" aria-pressed="true" block outline
                                                 type="primary"
                                                 v-bind:class="{active: model.gender=='男', 'btn-sm': true}">男
                                    </base-button>
                                </div>
                                <div class="col-lg-6">
                                    <base-button @click="model.gender='女'" aria-pressed="true" block outline
                                                 type="primary"
                                                 v-bind:class="{active: model.gender=='女', 'btn-sm': true}">女
                                    </base-button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <base-button @click='register' class="my-4" type="primary">创建账户</base-button>
                        </div>
                    </form>
                </div>
            </div>
